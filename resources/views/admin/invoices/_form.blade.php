    ...
    <div class="vd-card border-vd-formBorder !p-6">
        ...
        <div class="grid gap-6 sm:grid-cols-2 mb-6">
            ...
            <div>
                ...
                <x-form-input id="download_expired_at" name="download_expired_at" type="date" value="{{ $invoice?->download_expired_at?->format('Y-m-d') ?? old('download_expired_at') }}" class="mt-2" />

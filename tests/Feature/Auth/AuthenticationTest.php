...
class AuthenticationTest extends TestCase
{
    ...
    public function test_users_can_not_authenticate_without_recaptcha_when_enabled(): void
    {
        $user = User::factory()->create();
    ...
    public function test_users_can_authenticate_with_valid_recaptcha_when_enabled(): void
    {
        $user = User::factory()->create();
